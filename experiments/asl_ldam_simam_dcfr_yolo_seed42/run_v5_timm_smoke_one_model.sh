...
OUT="/home/drnguyenvinh/notebooks/final_loss_cbam_top5_noise_v5_stage1split_TIMM_SMOKE_${MODEL}_seed${SEED}_outputs"
LOG="/home/drnguyenvinh/notebooks/final_loss_cbam_top5_noise_v5_stage1split_TIMM_SMOKE_${MODEL}_seed${SEED}_live.log"
ZIP="/home/drnguyenvinh/notebooks/final_loss_cbam_top5_noise_v5_stage1split_TIMM_SMOKE_${MODEL}_seed${SEED}_RESULTS_ONLY.zip"

echo "=== V5 TIMM SMOKE ONE MODEL ==="
echo "MODEL=$MODEL"
echo "SEED=$SEED"
...
echo "LOG=$LOG"
echo "ZIP=$ZIP"
echo "NOTE=1-epoch smoke only. Do not use metrics for paper ranking."
