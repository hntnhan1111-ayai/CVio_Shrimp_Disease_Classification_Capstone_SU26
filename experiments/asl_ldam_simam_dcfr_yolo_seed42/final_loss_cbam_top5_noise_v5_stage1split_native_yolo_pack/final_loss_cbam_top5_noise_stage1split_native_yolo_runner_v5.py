...
def import_project(project: Path):
    ...
    sys.path = [p for p in sys.path if '/home/drnguyenvinh/notebooks/YOLO26M_' not in str(p)]
...
def main():
    ...
    ap.add_argument('--project_dir', default='/home/drnguyenvinh/notebooks/YOLO26M_CE_VS_ASL_LDAM_NOISY_TEST_EVAL_project')
    ap.add_argument('--asl_project_dir', default='/home/drnguyenvinh/notebooks/YOLO26M_CE_VS_ASL_LDAM_NOISY_TEST_EVAL_project')
    ap.add_argument('--ce_project_dir', default='/home/drnguyenvinh/notebooks/YOLO26M_CE_TOP10_CUSTOM_LOSS_CBAM_WORK_project')
    ap.add_argument('--dataset_root', default='/home/drnguyenvinh/notebooks/processed-images/processed_images')
    ap.add_argument('--output_dir', default='/home/drnguyenvinh/notebooks/yolo26m_final_loss_cbam_top9_noise_eval_v2_outputs')
    ap.add_argument('--patch_script', default='/home/drnguyenvinh/notebooks/patch_yolo_attention_injection_v2.py')
    ...
    ap.add_argument('--zip_path', default='/home/drnguyenvinh/notebooks/yolo26m_final_loss_cbam_top9_noise_eval_v2_RESULTS_ONLY_for_review.zip')
    args = ap.parse_args()
    ...
    if not args.skip_patch:
        ...
        run([sys.executable, str(patch), '--project_dir', str(asl_project), '--run_compileall'], Path('/home/drnguyenvinh/notebooks'), log_dir/'020_patch_attention_cbam_asl_project.log', env)
        run([sys.executable, str(patch), '--project_dir', str(ce_project), '--run_compileall'], Path('/home/drnguyenvinh/notebooks'), log_dir/'021_patch_attention_cbam_ce_project.log', env)
