...
| Ultralytics version | ultralytics==8.4.62
| torch/cuda verions | torch-2.10.0+cu128
...
| Primary metric | labeled-only test mask mAP50 |

mAp là seg map, không phải box map

## Current Leaderboard (tổng hợp tất cả phương pháp và metrics record được)
