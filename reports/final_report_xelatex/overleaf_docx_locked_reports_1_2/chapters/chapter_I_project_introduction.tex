...
\begingroup
\CVioTableSetup
\begin{longtable}{|>{\centering\arraybackslash}p{3.63cm}|>{\centering\arraybackslash}p{10.35cm}|}
\caption{Project information}\\
\hline
\CVioPeachHeader\textbf{Item} & \textbf{Information} \\ \hline
\endfirsthead
...
\rev{Vietnamese project name} & \revunicode{Phát}\ \revunicode{hiện}\ \revunicode{bệnh}\ \revunicode{tôm}\ \revunicode{bằng}\ \revunicode{mô}\ \revunicode{hình}\ \revunicode{học}\ \revunicode{sâu}\ \revunicode{nhẹ}\ \revunicode{trên}\ \revunicode{thiết}\ \revunicode{bị}\ \revunicode{di}\ \revunicode{động}\ \revunicode{trong}\ \revunicode{nhiều}\ \revunicode{điều}\ \revunicode{kiện}\ \revunicode{môi}\ \revunicode{trường}\ \revunicode{khác}\ \revunicode{nhau} \\ \hline
...
\begingroup
\CVioTableSetup
\begin{longtable}{|>{\centering\arraybackslash}p{3.80cm}|>{\centering\arraybackslash}p{4.51cm}|>{\centering\arraybackslash}p{2.47cm}|>{\centering\arraybackslash}p{3.19cm}|}
\caption{Supervisor information}\\
\hline
\CVioPeachHeader\textbf{Full Name} & \textbf{Email} & \textbf{Mobile} & \textbf{Title} \\ \hline
\endfirsthead
...
\begingroup
\CVioTableSetup
\begin{longtable}{|>{\centering\arraybackslash}p{3.60cm}|>{\centering\arraybackslash}p{5.00cm}|>{\centering\arraybackslash}p{2.50cm}|>{\centering\arraybackslash}p{2.90cm}|}
\caption{Team member information}\\
\hline
\CVioPeachHeader\textbf{Full Name} & \textbf{Email} & \textbf{Mobile} & \textbf{Role} \\ \hline
\endfirsthead
...
\begingroup
\CVioTableSetup
\begin{longtable}{|>{\centering\arraybackslash}p{2.74cm}|>{\centering\arraybackslash}p{5.30cm}|>{\centering\arraybackslash}p{5.93cm}|}
\caption{Final project scope and explicit limitations}\\
\hline
\CVioPeachHeader\textbf{Scope component} & \textbf{Included work} & \textbf{Boundary / limitation} \\ \hline
\endfirsthead
