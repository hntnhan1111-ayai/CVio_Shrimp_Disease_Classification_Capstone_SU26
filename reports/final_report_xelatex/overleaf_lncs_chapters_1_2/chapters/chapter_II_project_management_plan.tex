...
\begingroup
\CVioTableSetup
\begin{longtable}{|>{\centering\arraybackslash}p{2.04cm}|>{\centering\arraybackslash}p{1.50cm}|>{\centering\arraybackslash}p{1.84cm}|>{\centering\arraybackslash}p{5.17cm}|}
\caption{Team structure and roles}\\
\hline
\rowcolor{cvioPeach}\textbf{Member} & \textbf{Student ID} & \textbf{Role} & \textbf{Main responsibilities} \\ \hline
\endfirsthead
...
\begingroup
\CVioTableSetup
\begin{longtable}{|>{\centering\arraybackslash}p{2.72cm}|>{\centering\arraybackslash}p{8.02cm}|}
\caption{Roles and responsibilities}\\
\hline
\rowcolor{cvioPeach}\textbf{Role} & \textbf{Responsibility} \\ \hline
\endfirsthead
...
\begingroup
\CVioTableSetup
\begin{longtable}{|>{\centering\arraybackslash}p{2.45cm}|>{\centering\arraybackslash}p{4.90cm}|>{\centering\arraybackslash}p{1.43cm}|>{\centering\arraybackslash}p{1.97cm}|}
\caption{Project communication plan}\\
\hline
\rowcolor{cvioPeach}\textbf{Communication item} & \textbf{Participants and purpose} & \textbf{Frequency} & \textbf{Tool / method} \\ \hline
\endfirsthead
...
\hline
\rowcolor{cvioPeach}\textbf{CRISP-DM phase} & \textbf{project application} \\ \hline
\endfirsthead
...
\CVioTableSetup
\scriptsize
\begin{longtable}{|>{\centering\arraybackslash}p{0.82cm}|>{\centering\arraybackslash}p{6.32cm}|>{\centering\arraybackslash}p{1.77cm}|>{\centering\arraybackslash}p{1.63cm}|}
\caption{Detailed Work Breakdown Structure and estimated effort}\\
\hline
\rowcolor{cvioPeach}\textbf{\#} & \textbf{WBS Item} & \textbf{Complexity} & \textbf{Est. effort (man-days)} \\ \hline
\endfirsthead
...
\CVioTableSetup
\scriptsize
\begin{longtable}{|>{\centering\arraybackslash}p{3.06cm}|>{\centering\arraybackslash}p{1.77cm}|>{\centering\arraybackslash}p{1.77cm}|>{\centering\arraybackslash}p{1.77cm}|>{\centering\arraybackslash}p{1.77cm}|}
\caption{Responsibility assignments}\\
\hline
\rowcolor{cvioPeach}\textbf{Responsibility} & \textbf{Tran Huu Nhan} & \textbf{Le Thi Huynh Nhu} & \textbf{Nguyen Van Phong} & \textbf{Nguyen Dinh Vinh} \\ \hline
\endfirsthead
...
\CVioTableSetup
\scriptsize
\begin{longtable}{|>{\centering\arraybackslash}p{0.68cm}|>{\centering\arraybackslash}p{3.26cm}|>{\centering\arraybackslash}p{2.31cm}|>{\centering\arraybackslash}p{4.22cm}|}
\caption{Project risks and response plans}\\
\hline
\rowcolor{cvioPeach}\textbf{\#} & \textbf{Risk description} & \textbf{Impact / likelihood} & \textbf{Response plan} \\ \hline
\endfirsthead
...
\begingroup
\CVioTableSetup
\begin{longtable}{|>{\centering\arraybackslash}p{2.18cm}|>{\centering\arraybackslash}p{5.51cm}|>{\centering\arraybackslash}p{3.06cm}|}
\caption{Quality management plan}\\
\hline
\rowcolor{cvioPeach}\textbf{Quality area} & \textbf{Control activities} & \textbf{Acceptance output} \\ \hline
\endfirsthead
...
\begingroup
\CVioTableSetup
\begin{longtable}{|>{\centering\arraybackslash}p{2.52cm}|>{\centering\arraybackslash}p{5.24cm}|>{\centering\arraybackslash}p{2.99cm}|}
\caption{Project resources and funding status}\\
\hline
\rowcolor{cvioPeach}\textbf{Resource category} & \textbf{Resource / funding source} & \textbf{Recorded cost status} \\ \hline
\endfirsthead
...
\begingroup
\CVioTableSetup
\begin{longtable}{|>{\centering\arraybackslash}p{2.72cm}|>{\centering\arraybackslash}p{3.88cm}|>{\centering\arraybackslash}p{4.15cm}|}
\caption{Change categories and control requirements}\\
\hline
\rowcolor{cvioPeach}\textbf{Change category} & \textbf{Assessment criterion} & \textbf{Required control} \\ \hline
\endfirsthead
...
\begingroup
\CVioTableSetup
\begin{longtable}{|>{\centering\arraybackslash}p{2.99cm}|>{\centering\arraybackslash}p{7.75cm}|}
\caption{Project closure and Definition of Done}\\
\hline
\rowcolor{cvioPeach}\textbf{Closure criterion} & \textbf{Definition of Done} \\ \hline
\endfirsthead
